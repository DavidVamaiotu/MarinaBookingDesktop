...
Client desktop Electron pentru rezervările WordPress Booking Calendar prin **Marina Booking API v1.0.7+**. Păstrează designul și interacțiunile timeline-ului Parkline Web, înlocuind serverul local vechi cu un proces principal securizat, bazat exclusiv pe API.
...
2. Rulează `dist-electron/MarinaBookingDesktop-Setup-1.0.23.exe`.
